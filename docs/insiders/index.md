...
*griffe-pydantic* follows the **sponsorware** release strategy, which means
...
*griffe-pydantic Insiders* is a private fork of *griffe-pydantic*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *griffe-pydantic*.
...
*griffe-pydantic* and released for general availability, making them available
...
<small>
  ...
  your profile and avatar to show your support for *griffe-pydantic*.
...
to use *griffe-pydantic* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *griffe-pydantic*. Almost all new features
...
Insiders* precisely under the same terms as *griffe-pydantic*, which are given
