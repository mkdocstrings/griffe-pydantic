...
*griffe-pydantic Insiders* is a compatible drop-in replacement for *griffe-pydantic*,
...
*griffe-pydantic Insiders* can be installed with `pip` [using SSH][using ssh]:
...
Of course, you can use *griffe-pydantic Insiders* directly using Git:
...
When upgrading Insiders, you should always check the version of *griffe-pydantic*
